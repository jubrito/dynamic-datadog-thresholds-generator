...
describe("EndpointStatistics", () => {
  ...
  it("should show/hide stats section from screen readers based on the show stats state", async () => {
    render(
      <EndpointStatistics endpointStats={baseStats} showInsights={true} />
    );

    expect(screen.getByLabelText("Endpoint insights")).toHaveAttribute(
      "aria-hidden",
      "true"
    );
